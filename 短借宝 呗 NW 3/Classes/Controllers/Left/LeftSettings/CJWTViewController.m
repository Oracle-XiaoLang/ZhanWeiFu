...
- (void)viewDidLoad {
    ...
    [shuju1 addObject:@"1Q:极速借款与普通借款区别？"];
    [shuju1 addObject:@"2Q:什么是信用积分？"];
    [shuju1 addObject:@"3Q:借款是否需要支付费用？"];
    [shuju1 addObject:@"4Q:如何还款？"];
    [shuju1 addObject:@"5Q:可以提前还款吗？"];
    [shuju1 addObject:@"6Q:没有及时还款怎么样？"];
    [shuju1 addObject:@"7Q:为什么通过初审了，借款还没有到帐？"];
    [shuju1 addObject:@"8Q:为什么我的借款审核不通过？"];
    [shuju1 addObject:@"9Q:创业项目提交后，什么时候能够知道申请是否通过？"];
    [shuju1 addObject:@"10Q:我提交的信息会泄露给第三方吗？"];
    
    [shuju2 addObject:@"A:极速借款提交申请通过审核后，一般2小时内到账。普通贷到帐时间相对较长。"];
