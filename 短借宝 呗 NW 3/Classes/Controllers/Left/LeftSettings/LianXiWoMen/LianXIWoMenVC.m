...
- (void)viewDidLoad {
    ...
    FenXingMingZi.text=@"公众号:15776420041";
    ...
    //
    dataArray = @[@{@"image":@"",@"title":@"15776420041"},@{@"image":@"",@"title":@"15776420042"},@{@"image":@"",@"title":@"15776420043"},@{@"image":@"",@"title":@"15776420047"},@{@"image":@"",@"title":@"15246804715"},@{@"image":@"",@"title":@"15246804716"},@{@"image":@"",@"title":@"15246804717"},@{@"image":@"",@"title":@"15246804718"},@{@"image":@"",@"title":@"15246804719"}];
 ...
 //
    ...
    QQ=[[UILabel alloc]initWithFrame:CGRectMake(v.frame.origin.x-45, v.frame.size.height/3.5, v.frame.size.width/2, 20)];
    QQ.text=@"QQ:3213563017";
    ...
    //
    dataArray1 = @[@{@"image":@"",@"title":@"3213563017"},
                           @{@"image":@"",@"title":@"3324792739"},
                           @{@"image":@"",@"title":@"3186007739"},
                           @{@"image":@"",@"title":@"3239542642"},
                           @{@"image":@"",@"title":@"2647926754"},@{@"image":@"",@"title":@"1396465286"},@{@"image":@"",@"title":@"2765377134"},@{@"image":@"",@"title":@"2698939705"},@{@"image":@"",@"title":@"3325727264"}];
    ...
    ShouJiHao=[[UILabel alloc]initWithFrame:CGRectMake(v.frame.origin.x-45, v.frame.size.height/3.5, v.frame.size.width/2, 20)];
    ShouJiHao.text=@"15776420041";
    ...
    //
    dataArray2 = @[@{@"image":@"",@"title":@"15776420041"},
                           @{@"image":@"",@"title":@"15776420042"},
                           @{@"image":@"",@"title":@"15776420043"},
                           @{@"image":@"",@"title":@"15776420047"},
                           @{@"image":@"",@"title":@"15246804715"},@{@"image":@"",@"title":@"15246804716"},@{@"image":@"",@"title":@"15246804717"},@{@"image":@"",@"title":@"15246804718"},@{@"image":@"",@"title":@"15246804719"}];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (index==1) {
        ...
        FenXingMingZi.text=[NSString stringWithFormat:@"公众号:%@",[dataArray[indexPath.row] objectForKey:@"title"]];
...
-(void)ShouJiHaoKaiQi
{
    //[CommonMethod callPhone:@"400-800-123456" superView:self.view];
    
    index=3;
    [self.view addSubview:rexiandown];
...
-(void)QQKaiQi
{
//    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://wpa.qq.com/msgrd?v=3&uin=1234567890&site=qq&menu=yes"]];
    index=2;
    [self.view addSubview:qqdown];
    [weixindown removeFromSuperview];
     [rexiandown removeFromSuperview ];
}
-(void)WeiXinKaiQi
...
//    }
    ...
    [self.view addSubview:weixindown];
    [qqdown removeFromSuperview];
    [rexiandown removeFromSuperview];
    
    
    
    //[self.view sendSubviewToBack:weixindown];
