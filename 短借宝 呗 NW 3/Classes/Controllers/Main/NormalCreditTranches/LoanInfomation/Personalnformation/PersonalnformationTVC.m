...
@interface PersonalnformationTVC ()<UITextFieldDelegate, HZAreaPickerDelegate>
{
    UIDatePicker *picker;
    MBProgressHUD *HUD;
    CGFloat width;
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField
{
    ...
    _areaText.inputView=self.locatePicker.locatePicker;
...
//    [self.areaText addTarget:self action:@selector(areaTextAcion) forControlEvents:UIControlEventEditingDidBegin|UIControlEventValueChanged];
    ...
    self.GeRenXinXi_ShengRi_Field.inputView = picker;
    //    self.tfTwo.inputView = picker;
    
    
    [picker addTarget:self action:@selector(pickerAction) forControlEvents:UIControlEventTouchUpInside|UIControlEventValueChanged];
    
    [self.GeRenXinXi_ShengRi_Field addTarget:self action:@selector(pickerAction) forControlEvents:UIControlEventEditingDidBegin|UIControlEventValueChanged];
    ...
    if (self.view.frame.size.height<569) {
       ...
       // self.btn=[[UIButton alloc]initWithFrame:CGRectMake(10,(self.view_button.frame.size.height-self.btn.frame.size.width)/4, self.view_button.frame.size.width-20, (self.view_button.frame.size.height-self.btn.frame.origin.y)/2+4)];
        self.btn = [[UIButton alloc]initWithFrame:CGRectMake(0,5,width-10,40)];
...
- (void)pickerAction {
    ...
    self.GeRenXinXi_ShengRi_Field.text = [formatter stringFromDate:date];
