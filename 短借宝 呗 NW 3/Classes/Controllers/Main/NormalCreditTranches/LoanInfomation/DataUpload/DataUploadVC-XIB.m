...
- (void)viewDidLoad {
    ...
    if (([d1 objectForKey:@"benrenzflag"]!=nil && [[d1 objectForKey:@"benrenzflag"] intValue]==1)||zjz33.length>0) {
        ...
        [self.benren setImage:[UIImage imageNamed:@"ziliao01_05.png"] forState:UIControlStateNormal];
    }

    
    if (([d1 objectForKey:@"xueshengzflag"]!=nil && [[d1 objectForKey:@"xueshengzflag"] intValue]==1)||zjz44.length>0) {
        
        [self.xuesheng setImage:[UIImage imageNamed:@"ziliao01_09.png"] forState:UIControlStateNormal];
    }
...
- (IBAction)btn:(UIButton *)sender {
    ...
    if (([[d1 objectForKey:@"shenfenzflag"] intValue]==1 && [d1 objectForKey:@"shenfenfflag"]!=nil && [d1 objectForKey:@"benrenzflag"]!=nil && [[d1 objectForKey:@"xueshengzflag"] intValue]==1) || (zjz11.length>0 && zjz22.length>0 && zjz33.length>0 && zjz44.length>0)) {
        ...
        NSLog(@"shoudaode -------%@",ddd);
        [d1 setObject:[ddd objectForKey:@"zjz1"] forKey:@"zjz1"];
        [d1 setObject:[ddd objectForKey:@"zjz2"] forKey:@"zjz2"];
        [d1 setObject:[ddd objectForKey:@"zjz3"] forKey:@"zjz3"];
        [d1 setObject:[ddd objectForKey:@"zjz4"] forKey:@"zjz4"];
...
//    else if (zjz11.length>0 && zjz22.length>0 && zjz33.length>0 && zjz44.length>0){
//        
//        //        提示
//        HUD = [MBProgressHUD showHUDAddedTo:self.navigationController.view animated:YES];
//        
