...
- (void)viewDidLoad {
    ...
    NSString *zjz3=[[NSUserDefaults standardUserDefaults] objectForKey:@"zjz3"];
    
    if (zjz3!=nil && zjz3.length>0)
    [self.photo setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",networkAddress,zjz3]] usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
    
    
    NSData *ss=[NSData dataWithContentsOfFile:[NSString stringWithFormat:@"%@/Documents/image2",NSHomeDirectory()]];
