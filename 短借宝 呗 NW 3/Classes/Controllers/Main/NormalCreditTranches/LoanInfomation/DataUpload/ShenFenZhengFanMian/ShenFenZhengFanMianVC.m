...
@interface ShenFenZhengFanMianVC ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate>{
...
@implementation ShenFenZhengFanMianVC
...

{
    ...
    if ([type isEqualToString:(NSString *)kUTTypeImage])
    {
        ...
        [fileManager createFileAtPath:[DocumentsPath stringByAppendingString:@"/image4.jpg"] contents:_data attributes:nil];
        
        
        [[NSUserDefaults standardUserDefaults] setObject:@"1" forKey:@"shenfenfflag"];
...
- (void)safe:(id)sender {
    ...
    if (([[[NSUserDefaults standardUserDefaults] objectForKey: @"shenfenfflag"] intValue]==1)|| [[[NSUserDefaults standardUserDefaults] objectForKey:@"zjz4"] length]>0) {
...
- (void)viewDidLoad {
    ...
    NSString *zjz2=[[NSUserDefaults standardUserDefaults] objectForKey:@"zjz4"];
    ...
    NSData *ss=[NSData dataWithContentsOfFile:[NSString stringWithFormat:@"%@/Documents/image4.jpg",NSHomeDirectory()]];
...
//    
//    [defaults3 setObject:imageData forKey:@"zjz4"];
