...
@interface TheContactInformationTVC ()<HMUTVCDelegate>{
    NSInteger a;
...
- (IBAction)shoujihao:(UIButton *)sender {
    ...
    aaViewController *l=[self.storyboard instantiateViewControllerWithIdentifier:@"aaView"];
    l.delegate = self;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    aaViewController *vc = segue.destinationViewController;
    vc.delegate = self;
