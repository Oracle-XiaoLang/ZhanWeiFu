...
//    if (self.toptext.text.intValue==500&&self.bottomtext.text.intValue==7) {
//        
//        self.topSlider.value=0.2;
//        self.bottomSlider.value=7/30;
//        self.toptext.text=@"1000";
//        self.bottomtext.text=@"15天";
//        self.feilu.text=@"45.00元";
//        
//    }
...
- (IBAction)XiaYiBupanduan:(UIButton *)sender {
    ...
    if ([[defaults3 objectForKey:@"DaiKuanShiFouKeYi"] integerValue]==1) {
        ...
        if ([defaults3 integerForKey:@"true"]==1) {
            ...
            if ([[defaults3 objectForKey:@"GeRenXinXi_SuoZaiDaXue_Field"] isEqual:@""]||[[defaults3 objectForKey:@"LianXiRenXinXi_Name_Field"] isEqual:@""]||[[defaults3 objectForKey:@"YinHangKaXinXi_KaiHuMingCheng_Field"] isEqual:@""]||[[defaults3 objectForKey:@"zjz1"] isEqual:@""]) {
