...
//            NSString *urlImage2=[NSString stringWithFormat:@"%@%@",url,zxfmA2];

//                NSLog(@"image11111111%@",urlImage1);
...
//                [tempArray addObject:[NSDictionary dictionaryWithObjects:@[urlImage2,zxbtA2,@NO,PlaceholderImage] forKeys:@[@"pic",@"title",@"isLoc",@"placeholderImage"]]];
...
//            NSLog(@"111111111111%@",self.tempArray);
...
//        if (!_Topic) {
//            //实例化
//            _Topic = [[JCTopic alloc]init];
//            _Topic.frame = self.scorllOfView.bounds;
//            
//            
//            
//            //代理
...
//            
////            NSString *url=@"http://192.168.1.53:8080/";
////            NSString *urlImage1=[NSString stringWithFormat:@"%@%@",url,zxfmA1];
//            
////            NSLog(@"image11111111%@",urlImage1);
//            
//            
//            [tempArray addObject:[NSDictionary dictionaryWithObjects:@[@"http://192.168.1.53:8080/framework/upload_file/1437978706017.jpg",@"新闻资讯1",@NO,PlaceholderImage] forKeys:@[@"pic",@"title",@"isLoc",@"placeholderImage"]]];
//            
//            [tempArray addObject:[NSDictionary dictionaryWithObjects:@[@"http://192.168.1.53:8080/framework/upload_file/1437978706017.jpg" ,@"新闻资讯2",@NO,PlaceholderImage] forKeys:@[@"pic",@"title",@"isLoc",@"placeholderImage"]]];
//            
//            //加入数据
//            _Topic.pics = tempArray;
//            //更新
//            [_Topic upDate];
//            [self.scorllOfView addSubview:_Topic];
//        }
//        
    }];
//    
